...
/**
 * Factory creating proxies specifically for the RestClient. All methods abstract methods are proxied.
 * Based on deltaspike code and required CDI (BeanManager), see also {@link BasicRestClientProxyFactory}.
 */
